...
class OrderFromImageView extends GetView<OrderFromImageController> {
  const OrderFromImageView({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<OrderFromImageController>(builder: (controller) {
      return Scaffold(
